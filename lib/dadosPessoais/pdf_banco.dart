...
Future<void> createPDF(
  ...
  String texto2 =
      'Além disso, esclarecemos que a presente declaração tem por finalidade atestar a veracidade da relação empregatícia entre a empresa e o colaborador mencionado, sendo válida para todos os fins legais, em especial para as instituições bancárias que necessitem de comprovação da situação laboral do mesmo.';
...
// Draw título
  String titulo = 'Declaração para fins bancários';
